...
.LFB46:
	...
	movl	$.LC34, %edi
	call	puts
	movsd	GV+1064(%rip), %xmm4
	movl	GV+1020(%rip), %edx
	xorpd	%xmm3, %xmm3
	mulsd	%xmm4, %xmm4
	testl	%edx, %edx
	mulsd	.LC35(%rip), %xmm4
	mulsd	GV+1096(%rip), %xmm4
	divsd	GV+1080(%rip), %xmm4
	jg	.L93
	jmp	.L81
	.p2align 4,,10
	.p2align 3
...
.L208:
	...
	call	puts
	movsd	.LC10(%rip), %xmm0
	movsd	GV+1064(%rip), %xmm6
	addsd	GV+1072(%rip), %xmm0
	movsd	GV+1104(%rip), %xmm7
...
.L202:
	...
	divsd	%xmm2, %xmm1
	divsd	%xmm0, %xmm4
	movsd	%xmm1, GV+1056(%rip)
	movapd	%xmm4, %xmm0
	movsd	%xmm4, GV+1048(%rip)
	call	__printf_chk
	cvtsi2sd	GV+1016(%rip), %xmm1
	movsd	GV+1008(%rip), %xmm0
	movl	$.LC88, %esi
